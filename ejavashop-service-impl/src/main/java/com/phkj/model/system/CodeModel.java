...
import com.phkj.core.exception.ArgumentException;
import com.phkj.core.exception.BusinessException;
import com.phkj.dao.shop.write.system.CodeWriteDao;
...
public class CodeModel {
    ...
    public Integer createCode(Code code) {
        ...
        //如果当前存在事务，则加入改事务；如果当前没有事务，则创建一个新得事务
    ...
    public List<Map<String, Object>> customReport(String sql) {
        return codeDao.customReport(sql);
    }
