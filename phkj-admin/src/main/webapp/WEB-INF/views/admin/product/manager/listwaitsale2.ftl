...
<div data-options="region:'center'" border="false">
    <table id="dataGrid" class="easyui-datagrid"
           data-options="rownumbers:true
    					...
    					,url:'${currentBaseUrl}/list2?q_state=${q_state!''}'
        ...
        <tr>
            ...
            <th field="price1se" width="70" align="center">阶梯第一数量</th>
            <th field="price1" width="70" align="center">商城阶梯价1</th>
            <th field="percentageScale1" width="70" align="center">分佣比例1</th>
            <th field="price2se" width="70" align="center">阶梯第二数量</th>
            <th field="price2" width="70" align="center">商城阶梯价2</th>
            <th field="percentageScale2" width="70" align="center">分佣比例2</th>
            <th field="price3se" width="70" align="center">阶梯第三数量</th>
            <th field="price3" width="70" align="center">商城阶梯价3</th>
            <th field="percentageScale3" width="70" align="center">分佣比例3</th>
