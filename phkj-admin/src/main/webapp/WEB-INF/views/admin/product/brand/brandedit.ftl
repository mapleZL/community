...
<div class="wrapper">
    <div class="formbox-a">
        ...
        <@form.form method="post" action="${(domainUrlUtil.EJS_URL_RESOURCES)!}/admin/product/brand/update" class="validForm" id="addForm" name="addForm" enctype="multipart/form-data">
            <dl class="dl-group">
                ...
                <dd class="dd-group">
                    ...
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            ...
                            <a href="${domainUrlUtil.EJS_IMAGE_RESOURCES}/${(brand.image)!''}" target="_blank">点击查看</a>
                        </p>
                        <p class="p6 p-item">
