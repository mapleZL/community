	...
	<div id="searchbox" class="head-seachbox">
		...
		<form class="form-search" action="doForm" method="post" id="queryForm" name="queryForm">
			<div class="fluidbox"><!-- 不分隔 -->
				...
				<p class="p4 p-item">
					<label class="lab-item">年份 :</label>
					<select name="q_year" class="txt" id="q_year" style="text-align: center;">
...
<div data-options="region:'center'" border="false">
	<table id="dataGrid" class="easyui-datagrid" 
			data-options="rownumbers:true
						...
						,pageSize:'${pageSize}'
						,fit:true
    					,url:'${(domainUrlUtil.EJS_URL_RESOURCES)!}/admin/member/parter/panerTotalMonthList'
    					,queryParams:queryParamsHandler()
    					,onLoadSuccess:dataGridLoadSuccess
    					,method:'get'">
		<thead>
			<tr>
				<th field="month" width="150" align="center" halign="center">月份</th>
