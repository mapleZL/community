...
$(function(){
	...
	$("#add").click(function(){
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/admin/mindex/floor/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加楼层<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/mindex/floor">返回</a></span></h2>
		...
		<div class="form-contbox">
			...
			<dl class="dl-group">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							<label class="lab-item"><font class="red">*</font>楼层链接：</label>
							<input class="easyui-validatebox txt w280" type="text" id="link" name="link" value="${(mIndexFloor.link)!''}" data-options="required:true,validType:'length[0,200]'" >
						</p>
					</div>
					<br/>
					<div class="fluidbox">
