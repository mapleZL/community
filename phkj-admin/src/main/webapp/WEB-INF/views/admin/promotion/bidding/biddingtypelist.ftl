...
<script language="javascript">
	...
	$(function(){
		...
		$("#a-gridAdd").click(function(){
	 		window.location.href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/admin/promotion/biddingtype/add";
		});
		$("#a-gridEdit").click(function(){
			...
			if(selectedCode.state == 1) {
	 		...
	 		window.location.href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/admin/promotion/biddingtype/edit?id="+selectedCode.id;
		});	
		...
		$("#a-gridDel").click(function(){
            ...
            $.messager.confirm('提示', '确定删除吗？', function(r){
                if (r){
                    ...
                    $.ajax({
                        type:"POST",
                        url: "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/biddingtype/del",
                        dataType: "json",
        ...
        $("#a-gridAuditYes").click(function(){
            ...
            $.messager.confirm('提示', '确定要启用吗，启用之后商家可以在此分类下申请商品，C端客户可以查看到此分类？', function(r){
                if (r){
                    ...
                    $.ajax({
                        type:"POST",
                        url: "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/biddingtype/auditYes",
                        dataType: "json",
                        data: "id="+selectedCode.id,
                        cache:false,
                        success:function(data, textStatus){
         ...
         $("#a-gridAuditNo").click(function(){
            ...
            $.messager.confirm('提示', '确定要停用吗，停用之后商家不可以在此分类下申请商品，C端客户不可以查看到此分类和此分类下的商品？', function(r){
                if (r){
                    ...
                    $.ajax({
                        type:"POST",
                        url: "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/biddingtype/auditNo",
                        dataType: "json",
                        data: "id="+selectedCode.id,
                        cache:false,
                        success:function(data, textStatus){
...
<div data-options="region:'center'" border="false">
	<table id="dataGrid" class="easyui-datagrid" 
			data-options="rownumbers:true
						...
						,pageSize:'${pageSize}'
						,fit:true
    					,url:'${(domainUrlUtil.EJS_URL_RESOURCES)!}/admin/promotion/biddingtype/list'
