	...
	$("#auditPass").click(function(){
        $.messager.confirm('提示', '确定审核通过该活动吗？', function(r){
            if (r){
                ...
                $.ajax({
                    type:"POST",
                    url: "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/single/doaudit",
                    dataType: "json",
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">审核单品立减<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/single">返回</a></span></h2>
