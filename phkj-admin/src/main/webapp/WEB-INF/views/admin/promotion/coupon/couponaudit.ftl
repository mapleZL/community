...
$(function(){
	...
	$("#auditPass").click(function(){
        $.messager.confirm('提示', '确定审核通过该红包吗？', function(r){
            if (r){
                $.messager.progress({text:"提交中..."});
                $.ajax({
                    type:"POST",
                    url: "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/coupon/doaudit",
                    dataType: "json",
	...
	$("#auditReject").click(function(){
        ...
        $.messager.confirm('提示', '确定驳回该红包吗？', function(r){
            if (r){
                $.messager.progress({text:"提交中..."});
                $.ajax({
                    type:"POST",
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">审核红包<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/coupon">返回</a></span></h2>
