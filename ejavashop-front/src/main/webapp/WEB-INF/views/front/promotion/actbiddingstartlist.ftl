...
<link rel="stylesheet" type="text/css" href="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/css/groupCate.css">
    ...
    <div class="container" style="position:relative;">
      ...
      <!-- S 商品阶梯竞价 -->
      <h2 class="group-purchase-tit">商品阶梯竞价（未开始）</h2>
          ...
          <div class="group-cate-flxed">
            ...
            <div class="group-itemnav">
             ...
             <div class="dd">
                 ...
                 <p class="item">
                 	<a class="item-a item-a-cur" href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/bidding-start.html">未开始</a>
                 </p>
                 <p class="item">
                 	<a class="item-a" href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/bidding-end.html">已结束</a>
                 </p>
              </div>
              ...
              <div class="div-h3">
              	<#if actBiddingTypes??>
        			<#list actBiddingTypes as actBiddingType>
		                <h3 class="itemnav-h3">
		                  <a class="item-a <#if actBiddingType.id=type>item-a-cur</#if>" href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/bidding-start.html?type=${(actBiddingType.id)!}">${(actBiddingType.name)!""}</a>
		                </h3>
                	</#list>
                </#if>
              </div>
