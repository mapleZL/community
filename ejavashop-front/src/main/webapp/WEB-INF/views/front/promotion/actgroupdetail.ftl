				...
				<div class="left-box">
					<div class="mainImg">
						<a href="javascript:;">
							...
							<img style="width:360px;height:360px" jqimg="${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${(actGroup.image)!''}" src="${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${(actGroup.image)!''}" />
						</a>
					</div>
				</div>
				<div class="right-box">
					<div class="right-box-pad">
						...
						<div class="description">
							<ul>
								<li class="first-col-red">${(actGroup.name)!''}</li>
							</ul>
						</div>
						<div class="timeinfo">
							...
							<#else>
	          				...
	          				<div class="number-item">
								<span class="num">${(actGroup.virtualSaleNum + actGroup.saleNum)!0}</span>件已被抢<#if stageType!=3>，剩余库存：${(actBidding.stock)!0}</#if>
							</div>
						</div>
						...
						<div class="item-purch item-purch-tuan <#if stageType != 2 || actGroup.stock lt 1>over</#if>">
							<div class="item-flxed <#if stageType != 2 || actGroup.stock lt 1>item-flxed-over</#if>">
								<div class="newPrice">¥${(actGroup.price)?string('0.00')!'99999999'}</div>
								<div class="oldPrice"><del class="originPrice">¥${(actGroup.marketPrice)?string('0.00')!'99999999'}</del></div>
								<a class="oldPrice oldPrice-span" href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/product/${(product.id)!0}.html">对比原商品<span class="simsun">>></span></a>
								<div class="btn-box">
									<#if stageType?? && stageType == 1 >
										<!-- 即将开始 -->
										<a href="javascript:;" class="btn btn-gray">即将开团</a>
									<#elseif stageType?? && stageType == 2 >
										<!-- 正在进行 -->
										<a href="javascript:;" class="btn btn-red click-btn <#if actGroup.stock lt 1>btn-gray</#if>">马上团</a>
									<#else>
										<!-- 已经结束 -->
		...
		<div class='container'>
			<div class='left'>
				<div id='browse-browse-pop' class='m m2 related-buy'>
					...
					<div class='mc'>
						<ul>
							<#if actGroupTop?? && actGroupTop?size &gt; 0>
								<#list actGroupTop as top>
									<li class='fore1'>
										<div class='p-img'>
