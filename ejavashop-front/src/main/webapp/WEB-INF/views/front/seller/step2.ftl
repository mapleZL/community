...
<script type="text/javascript" src='${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/frontseller/js/step2.js'></script>
	...
	<div class='business-layout'>
		...
		<div class='joinin-concrete'>
			...
			<div id='apply_company_info' class='apply-company-info'>
				...
				<form action='${(domainUrlUtil.EJS_URL_RESOURCES)!}/store/step2save.html'
						...
						<tbody>
							...
							<tr>
								...
								<td><input name='telephone' type='text'
									class='form-control w200 w100'> <span></span></td>
							</tr>
							<tr>
								<th>传&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真&nbsp;&nbsp;：</th>
							...
							<tr>
								<th><i>*</i>
									拥有机型及台数：</th>
								<td><input name='engineSum' type='text'
									class='form-control w200 w100'> &nbsp; <span></span></td>
							</tr>
							<tr>
								<th><i>*</i>
									日&nbsp;&nbsp;&nbsp;产&nbsp;&nbsp;&nbsp;量&nbsp;&nbsp;&nbsp;：</th>
								<td><input name='madePerDay' type='text'
									class='form-control w200 w100'> &nbsp; <span></span></td>
							</tr>
							<tr>
								<th><i>*</i>
									员&nbsp;&nbsp;工&nbsp;&nbsp;人&nbsp;&nbsp;数&nbsp;&nbsp;：</th>
								<td><input name='employeeSum' type='text'
									class='form-control w200 w100'> &nbsp; <span></span></td>
							</tr>
							<tr>
								<th><i>*</i>
									现&nbsp;&nbsp;有&nbsp;&nbsp;品&nbsp;&nbsp;类&nbsp;&nbsp;：</th>
								<td><input name='ownCate' type='text'
									class='form-control w200'> &nbsp; <span></span></td>
							</tr>
							<tr>
								<th><i>*</i>
									擅&nbsp;&nbsp;长&nbsp;&nbsp;领&nbsp;&nbsp;域：&nbsp;&nbsp;</th>
								<td><input name='wellArea' type='text'
									class='form-control w200'> &nbsp; <span></span></td>
							</tr>
							<!--<tr>
								<th><i>*</i>
					...
					<table border='0' cellpadding="0" cellspacing="0" class='all'
						...
						<thead>
							<tr>
								<th colspan='20'>营业执照信息</th>
							</tr>
						</thead>
						<tbody>
						<tr>
								<th><i>*</i> 税务登记证：</th>
								<td><input type='file' name='up_taxLicense'>
									<span class='block'>请确保图片清晰，文字可辨并有清晰的红色公章。</span> <input
									type='hidden' name='up_taxLicense' class='error'>
									<span></span></td>
						</tr>
						<tr>
								<th><i>*</i> 组织机构代码证：</th>
								<td><input type='file' name='up_organization'>
									<span class='block'>请确保图片清晰，文字可辨并有清晰的红色公章。</span> <input
									type='hidden' name='up_organization' class='error'>
									<span></span></td>
						</tr>
						<tr>
								<th><i>*</i> 营业执照：</th>
								<td><input type='file' name='up_bussinessLicenseImage'>
									<span class='block'>请确保图片清晰，文字可辨并有清晰的红色公章。</span> <input
									type='hidden' name='up_bussinessLicenseImage' class='error'>
									<span></span></td>
						</tr>
				...
				<div class='bottom'>
					<!--<a href='javascript:void(0);' id='btn_apply_company_next'
						...
						<a href='javascript:void(0);' id='btn_apply_company_next'
						class='btn btn-default'
						onclick="$('#form_company_info').submit();">提交</a>
				</div>
			</div>
			<!-- end -->
