								...
								<div class='order-common-list'>
									...
									<div class='goods-items '>
										<div class='goods-item goods-item-extra'>
											<div class='p-img'>
												<a href='${(domainUrlUtil.EJS_URL_RESOURCES)!}/bidding/${(actBidding.id)!0}.html' target="_blank">
													<img width="80" height="80" src='${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${(actBidding.image)!""}'>
												</a>
											</div>
											<div class='goods-msg'>
												<div class='goods-msg-gel'>
													<div class='p-name'>
														<a href='${(domainUrlUtil.EJS_URL_RESOURCES)!}/bidding/${(actBidding.id)!0}.html' target='_blank'>${product.name1!''} ${productGoods.normName!''}</a>
													</div>
													<div class='p-price'>
