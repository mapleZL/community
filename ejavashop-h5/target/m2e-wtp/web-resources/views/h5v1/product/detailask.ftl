...
<body>
	...
	<header id="header">
		<div class="flex flex-align-center head-bar">
			<div class="flex-1 text-left"><a href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/product/${(productId)!0}.html?type=${(type)!0}"><span class="fa fa-angle-left"></span></a></div>
			<div class="flex-2 text-center">商品咨询</div>
			<div class="flex-1 text-right" id="fa-bars"></div>
		</div>
		<#include "/h5v1/commons/_hidden_menu.ftl" />
	</header>
	<!-- 头部 end-->
	<#-- <#include "/h5v1/product/producthead.ftl" />  -->
	<div class="flex goods-nav">
		<div class="flex-1"><a class="block" href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/product/info/${(productId)!0}.html?type=${(type)!0}">详细介绍</a></div>
		<div class="flex-1"><a class="block" href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/product/spec/${(productId)!0}.html?type=${(type)!0}">规格参数</a></div>
		<div class="flex-1"><a class="block" href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/product/comment/${(productId)!0}.html?type=${(type)!0}">商品评价</a></div>
		<div class="flex-1 active"><a class="block" href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/product/ask/${(productId)!0}.html?type=${(type)!0}">商品咨询</a></div>
	</div>
   			...
   			<#if askList?? && askList?size &gt; 0 >
   				...
   				<#list askList as ask>
   					<dl class="consult-dl mar-bt">
			    	 	<dt><img src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/img/d_img.jpg" width="60"><span>${(ask.userName)!""}</span></dt>
			    	 	<dd>
			    	 ...
			    	 <dl class="consult-dl mar-bt">
			    	 	<dt class="text-right"><span>ejavashop</span><img src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/img/d_img_1.jpg" width="60"></dt>
			    	 	<dd>
			    	 		<span class="arrow-up"></span>
			    	        <span class="arrow-up2"></span>
			    	        <div class="form-control consult_text">
...
<script type="text/javascript">
	...
	function addMoreAsk() {
		...
		$.ajax({
			type:"GET",
			url:"${(domainUrlUtil.EJS_URL_RESOURCES)!}/product/moreask.html",
			dataType:"html",
