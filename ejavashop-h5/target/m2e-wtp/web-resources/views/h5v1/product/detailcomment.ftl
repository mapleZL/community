...
<body>
	...
	<div class="flex goods-nav">
		...
		<div class="flex-1 active"><a class="block" href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/product/comment/${(productId)!0}.html?type=${(type)!0}">商品评价</a></div>
		<div class="flex-1"><a class="block" href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/product/ask/${(productId)!0}.html?type=${(type)!0}">商品咨询</a></div>
	</div>
	    				...
	    				<#list allCommentList as comment>
	    					<div class="flex bor-btom mar-bt">
				    			<div class="text-center pad-r">
				    				<img src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/img/d_img.jpg" alt="" width="80" height="80"><br>
...
<script type="text/javascript">
	...
	function addMoreComment(gradeType) {
		...
		$.ajax({
			type:"GET",
			url:"${(domainUrlUtil.EJS_URL_RESOURCES)!}/product/morecomment.html",
			dataType:"html",
