   ...
   <header id="header">
   	  <div class="flex flex-align-center head-bar">
   	  	 <div class="flex-1 text-left">
   	  	 	<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/tuan/${(actGroup.id)!0}.html">
      	...
      	<#if seller?? >
            ...
            <div>
           	  <#if product?? && productGoods?? >
	              <a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/tuan/${(actGroup.id)!0}.html" class="block">
	              <dl class="img-ul cart-ul flex">
	                <dt style="width:80px;height:80px;"><img src="${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${(actGroup.image)!''}"></dt>
