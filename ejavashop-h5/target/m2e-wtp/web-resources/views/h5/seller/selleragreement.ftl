...
<body class="bgff">
   ...
   <!-- 头部 end-->
	...
	<div class="s-container" id="container">
	  ...
	  <div class="b_confrim pad10">
	     <p><input type="checkbox" id="input_apply_agreement" value="">我已阅读并同意以上协议</p>
	     <p class="bort mar_top pad-top"><button type="button" class="btn btn-block btn-login" id="btn_apply_agreement_next" disabled="">下一步，填写企业资质信息</button></p>
	  </div>
	</div> 
	<!-- 主体结束 -->
...
<script>
	$(document).ready(function () {
		...
		$("#input_apply_agreement").click(function(){
			if($(this).prop("checked")){
				$("#btn_apply_agreement_next").removeAttr("disabled");
			}else{
				$("#btn_apply_agreement_next").attr("disabled","disabled");
			}
		});
