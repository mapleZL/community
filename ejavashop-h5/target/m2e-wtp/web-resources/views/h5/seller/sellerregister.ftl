   ...
   <header id="header">
	...
	<div class="s-container" id="container">
		...
		<div class="business-d-box">
			...
			<div class="form-group b_form-group">
				<label><font class="clr53">*</font>拥有机型及台数：</label>
				<input type="text" class="form-control" id="engineSum" name="engineSum" value="${(sellerApply.engineSum)!''}" placeholder="拥有机型及台数">
				<p class="clr53 font12"></p>
			</div>
			<div class="form-group b_form-group">
				<label><font class="clr53">*</font>日产量：</label>
				<input type="text" class="form-control" id="madePerDay" name="madePerDay" value="${(sellerApply.madePerDay)!''}" placeholder="日产量">
				<p class="clr53 font12"></p>
			</div>
			<div class="form-group b_form-group">
				<label><font class="clr53">*</font>员工人数：</label>
				<input type="text" class="form-control" id="employeeSum" name="employeeSum" value="${(sellerApply.employeeSum)!''}" placeholder="员工人数">
				<p class="clr53 font12"></p>
			</div>
			<div class="form-group b_form-group">
				<label><font class="clr53">*</font>现有品类：</label>
				<input type="text" class="form-control" id="ownCate" name="ownCate" value="${(sellerApply.ownCate)!''}" placeholder="现有品类">
				<p class="clr53 font12"></p>
			</div>
			<div class="form-group b_form-group">
				<label><font class="clr53">*</font>擅长领域：</label>
				<input type="text" class="form-control" id="wellArea" name="wellArea" value="${(sellerApply.wellArea)!''}" placeholder="擅长领域">
				<p class="clr53 font12"></p>
			</div>
			<!--<div class="form-group b_form-group">
		...
		<div class="business-d-box">
			<div class="form-group b_form-group">
				<label>营业执照：</label>
				<input type="file" class="form-control" id="up_bussinessLicenseImage" name="up_bussinessLicenseImage" placeholder="营业执照">
			...
			<div class="form-group b_form-group">
				<label>组织机构代码证：</label>
				<input type="file" class="form-control" id="up_organization" name="up_organization" placeholder="组织机构代码证">
			...
			<div class="form-group b_form-group">
				<label>税务登记证：</label>
				<input type="file" class="form-control" id="up_taxLicense" name="up_taxLicense" placeholder="税务登记证">
...
<script src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/js/jquery.validate.min.js"></script>
<!--日历-->
<link href="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/js/selectdate/mobiscroll.css" rel="stylesheet" type="text/css">
<script src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/js/selectdate/mobiscroll_002.js" type="text/javascript"></script>
<script src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/js/selectdate/mobiscroll.js" type="text/javascript"></script>   
<script src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/js/selectdate/mobiscroll_003.js" type="text/javascript"></script>
<script>
	function subClick() {
		...
		var validate = $("#registerForm").validate({
            ...
            submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form 
            	...
            	if ((up_bussinessLicenseImage == null || up_bussinessLicenseImage == "") 
            		...
            		element.empty();
            		element.append("<i class='fa fa-exclamation-triangle'>请选择营业执照</i>");
            		return false;
            	} else {
            		var element = $("#up_bussinessLicenseImage").siblings("p.clr53");
            		element.empty();
    			}
            	var up_organization = $("#up_organization").val();
            	var organization = $("#organization").val();
            	if ((up_organization == null || up_organization == "") 
            			&& (organization == null || organization == "")) {
            		var element = $("#up_organization").siblings("p.clr53");
            		element.empty();
            		element.append("<i class='fa fa-exclamation-triangle'>请选择组织机构代码证</i>");
            		return false;
            	} else {
            		var element = $("#up_organization").siblings("p.clr53");
            		element.empty();
    			}
            	var up_taxLicense = $("#up_taxLicense").val();
            	var taxLicense = $("#taxLicense").val();
            	if ((up_taxLicense == null || up_taxLicense == "") 
            			&& (taxLicense == null || taxLicense == "")) {
            		var element = $("#up_taxLicense").siblings("p.clr53");
            		element.empty();
            		element.append("<i class='fa fa-exclamation-triangle'>请选择税务登记证图片</i>");
            		return false;
            	} else {
            		var element = $("#up_taxLicense").siblings("p.clr53");
            		element.empty();
