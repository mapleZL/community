		    ...
		    <div class="mar-bt pos_relative">
	    		<dl class="flex list-dl">
					<dt style="width:80px; height:80px;"><a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/product/${(comment.productId)!0}.html" class="block"><img src="${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${comment.productLeadLittle!''}" width="80" height="80"></a></dt>
					<dd class="padl flex-2">
						<div class="product_name mar_top"><a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/product/${(comment.productId)!0}.html" class="block">${(comment.productName)!''}</a></div>
