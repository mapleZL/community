   	  ...
   	  <div class="flex flex-align-center head-bar">
   	  	 <div class="flex-1 text-left">
   	  	 	<#if productBackId?? && productBackId &gt; 0 >
	   	  	 	<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/back.html">
	   	  	 		<span class="fa fa-angle-left"></span>
	   	  	 	</a>
   	  	 	<#elseif productExchangeId?? && productExchangeId &gt; 0 >
   	  	 		<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/exchange.html">
	   	  	 		<span class="fa fa-angle-left"></span>
	   	  	 	</a>
	   	  	 <#else>
   	  	 ...
   	  	 <div class="flex-2 text-center">我要申诉</div>
   ...
   <!-- 头部 end-->
	...
	<div class="" id="complaintListDiv">
		<div class="oder-list sev-list">
	    	...
	    	<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/product/${(ordersProduct.productId)!0}.html?goodId=${(ordersProduct.productGoodsId)!0}" class="block">
...
<script src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/js/jquery.form.js"></script>
