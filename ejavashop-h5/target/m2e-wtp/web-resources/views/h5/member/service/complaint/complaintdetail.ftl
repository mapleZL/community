   ...
   <header id="header">
   	  <div class="flex flex-align-center head-bar">
   	  	 <div class="flex-1 text-left">
   	  	 	<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/complaint.html">
   	  	 		<span class="fa fa-angle-left"></span>
   	  	 	</a>
		 </div>
   	  	 <div class="flex-2 text-center">申诉详情</div>
		...
		<div class="oder-list sev-list">
	    	<h2 class="flex flex-pack-justify sev_regoods">
	    		<div>
	    		  ...
	    		  <p>申诉时间：${(complaint.createTime?string("yyyy-MM-dd HH:mm:ss"))!''}</p>
	    		</div>
	    		<div>
	    			<font class="clr53">
	  		    		<#if  complaint.state??>
		...
		<div class="user-infor user-infor2 bgff mar-bt font12">
	    	...
	    	<div class='starlist padt0'>
				<div class="font12">投诉图片：&nbsp;</div>
					...
					<div class='pad-t5 expertxt' style="height:200px; overflow:hidden;">
				  		<img  src="${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${(complaint.image)!''}">
				  	</div>
				  	<#else>
				  		无
				  	</#if>
	    	...
	    	<div class='starlist flex padt0'>
				...
				<#if complaint.sellerCompImage?? && complaint.sellerCompImage != ''>
				    <div class='pad-t5 expertxt'style="height:200px; overflow:hidden;">
			  		<img  src="${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${(complaint.sellerCompImage)!''}">
			  		</div>
			  	<#else>
			  		无
			  	</#if>
