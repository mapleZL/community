   ...
   <!-- 头部 end-->
	...
	<div >
	   <div class="pad10 text-right">
		<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/applydrawinginfo.html" class="btn btn-default">提现</a>
	   </div>
	<#if memberApplyDrawings??>
		...
		<#if memberApplyDrawings?? && memberApplyDrawings?size==pagesize>
			<div id="applydrawing_more_json" class="text-center font14 pad-top2 font14-color" >查看更多<i class="fa fa-angle-double-down"></i></div>
...
$(function(){
	$("#applydrawing_more_json").click(function(){
		...
		var urljson = "${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/applydrawingJson.html?pageNum=" + list_page;
