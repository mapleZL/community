...
import com.unionpay.acp.BaseHttpSSLSocketFactory.MyX509TrustManager;
import com.wxpay.bean.Message;
...
public class HttpUtil {
    ...
    public static String getAccessToken() throws Exception {
        ...
        String secret = ConfigKit.get("wxpay.app_secret");
        String jsonStr = HttpUtil.get(ConfigKit.get("wxpay.access.token").concat("&appid=") + appid
                                      + "&secret=" + secret);
