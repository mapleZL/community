...
public class WxpayController extends BaseController {
    ...
    public String topay(HttpServletRequest request, ModelMap dataMap, HttpServletResponse response,
                        String relationOrderSn, String orderNo, String money, String code,
                        String describe) {
        ...
        try {
            ...
            String appsecret = ConfigKit.get("wxpay.app_secret");
            String partner = ConfigKit.get("wxpay.partner");
            String partnerkey = ConfigKit.get("wxpay.pay_api_key");

            String openId = "";
            String URL = ConfigKit.get("wxpay.oauth.token");
            ...
            //商户订单号
            //            String out_trade_no = relationOrderSn;

            //订单生成的机器 IP
            String spbill_create_ip = WebUtil.getIpAddr(request);

            //这里notify_url是 支付完成后微信发给该链接信息，可以判断会员是否支付成功，改变订单状态等。
            String notify_url = ConfigKit.get("wxpay.notify_url");
            ...
            String xml = "<xml>" + "<appid>" + appid + "</appid>" + "<mch_id>" + mch_id
                         ...
                         + out_trade_no + "</attach>" + "<out_trade_no>" + out_trade_no
                         ...
                         + "</xml>";
            String createOrderURL = ConfigKit.get("wxpay.create_order_URL");
            String prepay_id = "";
