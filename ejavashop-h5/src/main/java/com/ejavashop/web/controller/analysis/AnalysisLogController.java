...
public class AnalysisLogController extends BaseController {
    ...
    public void browseLog(HttpServletRequest request, HttpServletResponse responsed) {
        ...
        BrowseLogMobile browseLog = new BrowseLogMobile();
