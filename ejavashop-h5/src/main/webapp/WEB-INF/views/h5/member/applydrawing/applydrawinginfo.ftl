   ...
   <header id="header">
   	  <div class="flex flex-align-center head-bar">
   	  	 <div class="flex-1 text-left">
   	  	 	<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/applydrawing.html">
   ...
   <!-- 头部 end-->
	...
	<div class="s-container">
	  <div class="pad10">
	  	  ...
	  	  <form id="loginForm" method="post" action="${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/doapplydrawing.html" onsubmit="return check()">
