	...
	<div id="askListDiv">
	    ...
	    <div class="mar-bt pos_relative">
	    	<dl class="flex list-dl">
	    		<a href='${(domainUrlUtil.EJS_URL_RESOURCES)!}/product/${(askinfo.productId)!0}.html' class='block'>
	    			<dt style="width:80px; height:80px;"><img src="${(domainUrlUtil.EJS_IMAGE_RESOURCES)!}${askinfo.productLeadLittle}"></dt>
	    		</a>
    		...
    		<div class="bgff pad10 evalute-list font12" style="display:;">
    		   <div class="starbox starbox2">
		    	 ...
		    	 <dl class="consult-dl mar-bt">
		    	 	<dt><img src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/img/d_img.jpg" width="60"><span>${(askinfo.userName)!""}</span></dt>
		    	 	<dd>
		    	 ...
		    	 <dl class="consult-dl mar-bt">
		    	 	<dt class="text-right"><span>商城回复</span><img src="${(domainUrlUtil.EJS_STATIC_RESOURCES)!}/img/d_img_1.jpg" width="60"></dt>
		    	 	<dd>
...
<script type="text/javascript">
	...
	function addMoreAsk() {
		...
		$.ajax({
			type:"GET",
			url:"${(domainUrlUtil.EJS_URL_RESOURCES)!}/member/morequestion.html",
			dataType:"html",
