   ...
   <header id="header">
   	  <div class="flex flex-align-center head-bar">
   	  	 <div class="flex-1 text-left">
				...
				<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/order/flashsale-${actInfo!''}.html">
	   	  	 		<span class="fa fa-angle-left"></span>
	   	  	 	</a>
	   	  	 	<#elseif orderType?? && orderType == "3" >
				<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/order/tuan-${actInfo!''}.html">
	   	  	 		<span class="fa fa-angle-left"></span>
	   	  	 	</a>
	   	  	 	<#elseif orderType?? && orderType == "4" >
				<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/order/bidding-${actInfo!''}.html">
	   	  	 		<span class="fa fa-angle-left"></span>
	   	  	 	</a>
	   	  	 	<#else>
	   	  	 	<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/order/info.html">
	   	  	 		<span class="fa fa-angle-left"></span>
	   	  	 	</a>
	   	  	 	</#if>
	   	  	 <#else>
            ...
            <dl class="address-list mar-bt">
            	...
            	<dd class="pad8">
            		...
            		<p class="text-right">
            			...
            			<a href="${(domainUrlUtil.EJS_URL_RESOURCES)!''}/member/editaddress.html?isFromOrder=${(isFromOrder)!0}&id=${(address.id)!0}&orderType=${(orderType)!''}&actInfo=${(actInfo)!''}">编辑</a>
            			<#if !(isFromOrder?? && isFromOrder == "1") >
            			<!-- 如果是从订单页跳转过来不显示删除按钮 -->
            			&nbsp;|&nbsp;
...
<script type="text/javascript">
	$(function(){
		...
		$(".adresbtn").click(function() {
			window.location.href=domain+"/member/editaddress.html?isFromOrder=${(isFromOrder)!0}&orderType=${(orderType)!''}&actInfo=${(actInfo)!''}";
		});
	});
