...
//				e.stopImmediatePropagation();
	...
	// 筛选一级菜单折叠
	// $(".menubox h2").on('click', function(e){
	//    var _this=$(this);
	//    var angle_down=_this.find(".fa-angle-down");
	//    angle_down.addClass('addangle-down').end().siblings().slideDown();
...
//	});
	...
	// 我的评价
	// $(".goods-sun ").on("click","a",function(){
	// 	$(this).parents(".list-dl").siblings('.evalute-list').toggleClass('evalute-list2');
	// });
	// 我的咨询
	// $(".goods-Consu ").on("click","a",function(){
	// 	$(this).parents(".list-dl").siblings('.evalute-list').toggleClass('evalute-list2');
	// });
