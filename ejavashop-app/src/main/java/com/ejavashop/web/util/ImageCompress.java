...
//            System.out.println("elapse time:" + (float) (System.currentTimeMillis() - c) / 1000.0F
//                               + "s");
//        }
//    }
//
...
//
//        Label statusLabel = new Label("Welcome to " + version);
//
...
//
//            float[] kernelData2 = { -0.125F, -0.125F, -0.125F, -0.125F, 2.0F, -0.125F, -0.125F,
//                    -0.125F, -0.125F };
...
//        float Ratio = 1.0F;
//
//        float widthRatio = maxWidth * 1f / width;
//        float heightRatio = maxHeight * 1f / height;
