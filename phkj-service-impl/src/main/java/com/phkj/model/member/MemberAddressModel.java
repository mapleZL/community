...
import com.phkj.dao.shop.write.member.MemberAddressWriteDao;
import com.phkj.entity.member.MemberAddress;
...
public class MemberAddressModel {
    ...
    public Integer getMemberAddressesCount(Integer memberId) {
        return memberAddressReadDao.getMemberAddressesCount(memberId);
    }
    ...
    public List<MemberAddress> getMemberAddresses(Integer memberId, Integer start, Integer size) {
        return memberAddressReadDao.getMemberAddresses(memberId, start, size);
    }
    ...
    public List<MemberAddress> getMemberAddressByMId(Integer memberId) {
        return memberAddressReadDao.getMemberAddresses(memberId, 0, null);
    }
    ...
    public MemberAddress getAddressById(Integer id) {
        ...
        return memberAddressReadDao.get(id);
    }
    ...
    public boolean saveMemberAddress(MemberAddress memberAddress) {
        ...
        int countall = memberAddressReadDao.getMemberAddressesCount(memberAddress.getMemberId());
