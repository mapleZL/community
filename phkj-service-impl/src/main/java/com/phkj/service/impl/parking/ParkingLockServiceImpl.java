...
public class ParkingLockServiceImpl implements ParkingLockService {
    ...
    public boolean unLock(String id, String type) {
        ...
        HttpPost httpPost = new HttpPost("http://114.55.170.236:8856/applet/mobile/operation/parkinglock/poleDown");
    ...
    public String getLockStatus(String id, String type) {
        ...
        //开始处理请求
        CloseableHttpClient build = HttpClientBuilder.create().build();
        HttpPost httpPost = new HttpPost("http://114.55.170.236:8856/applet/mobile/operation/parkinglock/queryStatus");
        StringEntity stringEntity = new StringEntity(JSON.toJSONString(map), "UTF-8");
        httpPost.setEntity(stringEntity);
        httpPost.setHeader("Content-Type", "application/json;charset=utf8");
        // 响应模型
