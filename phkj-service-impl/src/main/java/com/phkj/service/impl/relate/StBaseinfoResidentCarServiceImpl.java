...
public class StBaseinfoResidentCarServiceImpl implements IStBaseinfoResidentCarService {
    private static Logger              log = LogManager
        .getLogger(StBaseinfoResidentCarServiceImpl.class);
    ...
    */
    ...
    public ServiceResult<StBaseinfoResidentCar> getStBaseinfoResidentCarById(Long stBaseinfoResidentCarId) {
        ...
        try {
            result.setResult(
                stBaseinfoResidentCarModel.getStBaseinfoResidentCarById(stBaseinfoResidentCarId));
        } catch (BusinessException e) {
            result.setSuccess(false);
            result.setMessage(e.getMessage());
            log.error("[IStBaseinfoResidentCarService][getStBaseinfoResidentCarById]根据id["
                      + stBaseinfoResidentCarId + "]取得人员车辆登记表时出现未知异常：" + e.getMessage());
        } catch (Exception e) {
            result.setError(ConstantsEJS.SERVICE_RESULT_CODE_SYSERROR,
                ConstantsEJS.SERVICE_RESULT_EXCEPTION_SYSERROR);
            log.error("[IStBaseinfoResidentCarService][getStBaseinfoResidentCarById]根据id["
                      + stBaseinfoResidentCarId + "]取得人员车辆登记表时出现未知异常：",
                e);
        }
        return result;
    }
    ...
    public ServiceResult<Integer> saveStBaseinfoResidentCar(StBaseinfoResidentCar stBaseinfoResidentCar) {
        ...
        try {
            result.setResult(
                stBaseinfoResidentCarModel.saveStBaseinfoResidentCar(stBaseinfoResidentCar));
        } catch (BusinessException e) {
            result.setSuccess(false);
            result.setMessage(e.getMessage());
    ...
    */
    ...
    public ServiceResult<Integer> updateStBaseinfoResidentCar(StBaseinfoResidentCar stBaseinfoResidentCar) {
        ...
        try {
            result.setResult(
                stBaseinfoResidentCarModel.updateStBaseinfoResidentCar(stBaseinfoResidentCar));
        } catch (BusinessException e) {
            result.setSuccess(false);
            result.setMessage(e.getMessage());
            log.error(
                "[IStBaseinfoResidentCarService][updateStBaseinfoResidentCar]更新人员车辆登记表时出现未知异常："
                      + e.getMessage());
        } catch (Exception e) {
            result.setError(ConstantsEJS.SERVICE_RESULT_CODE_SYSERROR,
                ConstantsEJS.SERVICE_RESULT_EXCEPTION_SYSERROR);
            log.error(
                "[IStBaseinfoResidentCarService][updateStBaseinfoResidentCar]更新人员车辆登记表时出现未知异常：", e);
        }
        return result;
    }
     ...
     * @param id
     * @return
     * @see com.phkj.service.relate.IStBaseinfoResidentCarService#getAllCarByOwner(java.lang.Long)
     */
    @Override
    public ServiceResult<List<StBaseinfoResidentCar>> getAllCarByOwner(Long personStockId) {
        ServiceResult<List<StBaseinfoResidentCar>> result = new ServiceResult<List<StBaseinfoResidentCar>>();
        try {
            result.setResult(
                stBaseinfoResidentCarModel.getAllCarByOwner(personStockId));
        } catch (BusinessException e) {
            result.setSuccess(false);
            result.setMessage(e.getMessage());
            log.error("[IStBaseinfoResidentCarService][getAllCarByOwner]获取人员车辆登记表时出现未知异常："
                      + e.getMessage());
        } catch (Exception e) {
            result.setError(ConstantsEJS.SERVICE_RESULT_CODE_SYSERROR,
                ConstantsEJS.SERVICE_RESULT_EXCEPTION_SYSERROR);
