 ...
 */
@Controller
@RequestMapping(value = "admin/product/normattropt")
public class NormAttrOptController extends BaseController {
    private String baseUrl = "admin/product/normattropt/";
