                ...
                <dd class="dd-group">
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            ...
                            <input type="text" id="wms_category" name="wms_category" value="${(wmsClassify.wmsCategory)!''}" class="txt w200 easyui-validatebox" missingMessage="wms分类必填，2-20个字符" data-options="required:true,validType:'length[2,20]'"/>
                        </p>
                        <p class="p6 p-item">
                    		<label class="lab-item"><font class="red">*</font>是否使用: </label>
                    		<input type="radio" name="state" value="1" checked="checked">使用
                    		<input type="radio" name="state" value="2">不使用
                    	</p>
                    </div>
