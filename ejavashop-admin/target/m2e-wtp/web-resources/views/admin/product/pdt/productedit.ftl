                ...
                <dd class="dd-group">
                    ...
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            ...
                            <#if brand?? && brand?size &gt; 0>
                                <select id="productBrandId" name="productBrandId" level="0" class="txt w210" onclick="luowo_display(this.value)">
                                    <#list brand as brand>
                                        <option value="${(brand.id)!''}" <#if (brand.id)?? && brand.id == (product.productBrandId)>selected</#if>>${(brand.nameFirst)!''} ${(brand.name)!''}</option>
                                    </#list>
                                </select>
                            </#if>
                    ...
                    <div class="fluidbox">
                        ...
                        <p class="p6 p-item">
                            ...
                            <select name="wmsCategory" id="wmsCategory" level="0" class="w210">
                    			<#list wmsClassify as wmsCategory>
                                        <option value="${(wmsCategory.wmsCategory)!''}" <#if (wmsCategory.wmsCategory)?? && wmsCategory.wmsCategory == (product.wmsCategory)>selected</#if>>${(wmsCategory.wmsCategory)!''}</option>
                                 </#list>
                            </select>
                            <#--
                    ...
                    <div class="fluidbox">
                    	...
                    	<p class="p6 p-item">
                    		<label class="lab-item"></font>货主: </label>
                    		<select name="sellerId" id="sellerId" level="0" class="w210">
                    			<#list seller as seller>
                                        <option value="${(seller.id)!''}" <#if (seller.id)?? && seller.id == (product.sellerId)>selected</#if>>${(seller.sellerName)!''}</option>
                                 </#list>
                            </select>
                    	</p>
                    </div>
...
<script type="text/javascript">
	...
	$('#pro3').click(function(){
		...
		$('#labeldataGrid').datagrid({
			url:'${domainUrlUtil.EJS_URL_RESOURCES}/admin/operate/productLabel/list',
		    queryParams:queryParamsHandler()
		   });
	});
