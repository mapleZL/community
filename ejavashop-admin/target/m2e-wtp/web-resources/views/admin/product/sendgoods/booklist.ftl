...
<div data-options="region:'center'" border="false">
    ...
    <div id="gridTools">
        ...
        <@shiro.hasPermission name="/admin/product/sendgoods/returngoods">
       ...
       <@shiro.hasPermission name="/admin/product/sendgoods/returncheck">
       ...
       <@shiro.hasPermission name="/admin/product/sendgoods/passreturn">
