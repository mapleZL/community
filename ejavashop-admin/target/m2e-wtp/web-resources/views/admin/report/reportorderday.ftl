...
<#assign currentBaseUrl="${domainUrlUtil.EJS_URL_RESOURCES}/admin/report/orderday"/>
...
<div data-options="region:'center'" border="false">
    <table id="dataGrid" class="easyui-datagrid"
        ...
        <tr>
            ...
            <th field="moneyDiscount" width="100" align="center">优惠总金额</th>
            <!--<th field="servicePrice" width="100" align="center">套餐总费用</th>-->
            <!--<th field="labelPrice" width="100" align="center">标签总费用</th>-->
