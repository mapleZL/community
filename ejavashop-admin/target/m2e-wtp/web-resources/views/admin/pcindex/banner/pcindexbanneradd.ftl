...
$(function(){
	...
	$("#add").click(function(){
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/admin/pcindex/banner/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加轮播图<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/pcindex/banner">返回</a></span></h2>
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							顶部广告：<input  type="radio" id="type2" name="type" value="2"  onclick="javascript:showSortedId()"/>
						</p>
					</div>
					<br/>
					<div class="fluidbox" id = "sortedId">
						<p class="p12 p-item">
							...
							<input class="easyui-numberbox w280" type="text" id="orderNo" name="orderNo" value="${(pcIndexBanner.orderNo)!''}" data-options="max:99" >
						</p>
						<p class="p12 p-item">
							<label class="lab-item">&nbsp;</label>
							<label>
					...
					<div class="fluidbox">
						...
						<input type="text" id="startTime" name="startTime"
								...
								onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endTime\')}',minDate:'curentTime'});"
