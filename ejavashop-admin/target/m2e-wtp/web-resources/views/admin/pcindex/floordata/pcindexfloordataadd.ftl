...
$(function(){
	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/admin/pcindex/floordata/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
	...
	function backTo() {
		...
		if (fromClass == "1") {
			window.location.href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/pcindex/floorclass";
		} else {
