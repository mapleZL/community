...
<div id="aa" class="easyui-accordion" data-options="fit:true"
	...
	<div title="客户信息" class="ra_div">
		...
		<a href="javascript:void(0);" onclick="addTab('集合竞价首页图片', '${domainUrlUtil.EJS_URL_RESOURCES}/admin/actbiddingbanner/banner')">集合竞价首页图片</a>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="/admin/promotion/biddingtype">
		<a href="javascript:void(0);" onclick="addTab('集合竞价分类', '${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/biddingtype')">集合竞价分类</a>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="/admin/promotion/actbidding">
		<a href="javascript:void(0);" onclick="addTab('集合竞价管理', '${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/actbidding')">集合竞价管理</a>
		</@shiro.hasPermission> --%>
	</div>
	</@shiro.hasPermission>
