	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
			...
			if (parseFloat(minAmount) <= parseFloat(couponValue)) {
	 		...
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/coupon/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加红包<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/coupon">返回</a></span></h2>
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-numberbox txt w280" type="text" 
								id="totalLimitNum" name="totalLimitNum" value="${(coupon.totalLimitNum)!''}" 
