	...
	$("#edit").click(function(){
		...
		if($("#addForm").form('validate')){
			...
			if (channel == null || channel == "") {
	 		...
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/coupon/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑红包<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/coupon">返回</a></span></h2>
