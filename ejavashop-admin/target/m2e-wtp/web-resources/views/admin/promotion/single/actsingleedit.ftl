	...
	$("#edit").click(function(){
		...
		if($("#addForm").form('validate')){
	    	...
	    	if (type == 1) {
	 		...
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/single/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑单品立减<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/promotion/single">返回</a></span></h2>
					...
					<#if productList??>
						<#list  productList as product>
							<div class="fluidbox addItemT">
									<label class="lab-item">&nbsp;</label>
									<input type="hidden" id="ids" name="ids" value="${(product.sellerId)!''}:${(product.id)!''}" />
									商品名称：
