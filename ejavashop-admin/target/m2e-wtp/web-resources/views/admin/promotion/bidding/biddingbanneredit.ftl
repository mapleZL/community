...
$(function(){
	$("#back").click(function(){
 		window.location.href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/actbiddingbanner/banner";
	});
	$("#add").click(function(){
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/admin/actbiddingbanner/banner/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">修改集合竞价首页轮播图<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/actbiddingbanner/banner">返回</a></span></h2>
		
		<#--1.addForm----------------->
		<div class="form-contbox">
			<@form.form method="post" class="validForm" id="addForm" name="addForm" enctype="multipart/form-data">
				<input type="hidden" name="id" value="${(actBiddingBanner.id)!}" />
			<dl class="dl-group">
				...
				<dd class="dd-group">
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-validatebox txt w280" type="text" id="title" name="title" value="${(actBiddingBanner.title)!''}" data-options="required:true,validType:'length[5,50]'" >
						</p>
					</div>
					<br/>
					<div class="fluidbox">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<#if (actBiddingBanner.image)??> 
									&nbsp;&nbsp;&nbsp;&nbsp;<a href="${domainUrlUtil.EJS_IMAGE_RESOURCES}${(actBiddingBanner.image)!''}" target="_blank">查看图片</a>
							</#if>
						</p>
						<p class="p12 p-item">
							<label class="lab-item">&nbsp;</label>
