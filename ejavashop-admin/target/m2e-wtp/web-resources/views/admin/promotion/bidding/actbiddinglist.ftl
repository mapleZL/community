...
<#assign currentBaseUrl="${(domainUrlUtil.EJS_URL_RESOURCES)!}/admin/promotion/actbidding"/>
...
<script language="javascript">
	...
	$(function(){
		...
		<#noescape>
			...
			executeStateBox = eval('(${initJSCodeContainer("YES_NO")})');
		</#noescape>
		// 查询按钮
	...
	function executeStateFormat(value,row,index){
		return executeStateBox["YES_NO"][value];
	}
...
<div id="searchbar" data-options="region:'north'" style="margin:0 auto;" border="false">
	<h2 class="h2-title">集合竞价 <span class="s-poar"><a class="a-extend" href="#">收起</a></span></h2>
...
<div data-options="region:'center'" border="false">
	<table id="dataGrid" class="easyui-datagrid" 
		...
		<thead>
			<tr>
	            ...
	            <th field="virtualSaleNum" width="150" align="left" halign="center">虚拟销量</th>  
	...
	<div id="gridTools">
		...
		<@shiro.hasPermission name="/admin/promotion/actbidding/edit">
			<a id="a-gridEdit" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true">编辑</a>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="/admin/promotion/actbidding/auditYes">
			<a id="a-gridAuditYes" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true">审核通过</a>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="/admin/promotion/actbidding/auditNo">
			<a id="a-gridAuditNo" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true">审核驳回</a>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="/admin/promotion/actbidding/releaseFinal">
			<a id="a-gridReleaseFinal" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true">结束</a>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="/admin/promotion/actbidding/look">
...
<#----审核失败输入框-------------->
<#include "/admin/promotion/bidding/actbiddingaudit.ftl" />