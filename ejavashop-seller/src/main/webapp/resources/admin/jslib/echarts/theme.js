function EchartsTheme() {
	...
	var helianthus = {
		...
		// 默认色板
		color : [ '#44B7D3', '#E42B6D', '#F4E24E', '#FE9616', '#8AED35',
	...
	this.getTheme = function(name) {
		if (name == "infographic")
			...
			return blue;
		else if (name == "macarons2")
			return macarons2;
		else if (name == "red")
			return red;
		else if (name == "sakura")
			return sakura;
		else if (name == "helianthus")
			return helianthus;
		else if (name == "mint")
			return mint;
		else if (name == "roma")
