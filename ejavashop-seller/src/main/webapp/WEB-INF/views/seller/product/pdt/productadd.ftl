            	...
            	<dd class="dd-group">
                    <div class="fluidbox">
                   		<p class="p12 p-item">
							...
							<input type="text" id="productName" name="productName" style="width: 750px;" value="${(product.name1)!''}" readonly="readonly">
...
<#--                    <input type="hidden" id="state" name="state" value="6"/>-->
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            ...
                            <#if brand?? && brand?size &gt; 0>
                                <select id="brandId" name="brandId" level="0" class="txt w210" onclick="luowo_display(this.value)">
                                    <#list brand as brand>
                    ...
                    <div class="fluidbox">
                        ...
                        <p class="p6 p-item">
                            ...
                            <#if wmsClassify?? && wmsClassify?size &gt; 0>
                            	<select name="wmsCategory" level="0" class="w210">
	                            	<#list wmsClassify as wms>
	                                        <option value="${(wms.wmsCategory)!''}">${(wms.wmsCategory)!''}</option>
	                                </#list>
                                </select>
                            </#if>
                        </p>
                    ...
                    <div class="fluidbox">
                        ...
                        <p class="p6 p-item">
                            ...
                            <input type="text" id="percentageScale" name="percentageScale" value="" class="txt w200 easyui-numberbox" data-options="min:0.001,max:0.999,precision:3,required:true" missingMessage="分佣比例必填必填，0-1之间" />
                        </p>
                    </div>
                    ...
                    <div class="fluidbox">
                    	<p class="p6 p-item">
                    		...
                    		<input type="text" id="productUrl" name="productUrl" value="" class="txt w200 easyui-textbox"  missingMessage="百度网盘的路径" />
                    	</p>
                    	<p>
                    ...
                    <#--
                    	<p class="p6 p-item">
							...
							<input type="text" id="productPackageName" name="productPackageName" 
							  value="${(product.name1)!''}" readonly="readonly" class="txt w200 easyui-validatebox" missingMessage="加工方式必填" data-options="required:false" />
            ...
            <dl class="dl-group">
                ...
                <dd class="dd-group">
                    <div class="fluidbox" style="margin-left: 75px;">
                        <input type="checkbox" id="tzm_cxbh" style="vertical-align: middle;">
                        <input type="hidden" id="tzm_cxbh_use" name="isCxbh" />
                       		<label for="tzm_cxbh" style="cursor: pointer;">本品会持续补货</label>
                    </div>
                </dd>
            </dl>
            <dl class="dl-group">
