<#assign currentBaseUrl="${domainUrlUtil.EJS_URL_RESOURCES}/seller/system/sellerUser"/>
		...
		<div class="form-contbox">
			<dl class="dl-group">
				...
				<dd class="dd-group">
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<span id="nameSpan"> <input
								...
								class="txt w400" disabled/> <span class="title_span">登录账号名自动生成</span>
							</span>
						</p>
					</div>
					<#if admin??>
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							<label class="lab-item"><font class="red">*</font>编码: </label>
							<span id="telspan"> <input
								class="txt w200 easyui-validatebox" type="text" id="code"
								name="code" value="${(admin.code)!}"
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<span id="telspan"> <input
								class="txt w200 easyui-validatebox" type="text" id="realName"
								name="realName" value="${(admin.realName)!}"
								data-options="required:true,validType:'length[1,40]'"
								class="txt w400" /> <span class="title_span">长度为1-20个字符</span>
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<span id="telspan"> <input
								class="txt w200 easyui-validatebox" type="text" id="phone"
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							<label class="lab-item"><font class="red">*</font>职务: </label>
							<span id="telspan"> <input
								class="txt w200 easyui-validatebox" type="text" id="job"
								name="job" value="${(admin.job)!}"
								data-options="required:true,validType:'length[1,40]'"
								class="txt w400" /> <span class="title_span">长度为1-20个字符</span>
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<select id="state" class="txt w200 easyui-combobox" name="state"
								editable="false" data-options="required:true">
