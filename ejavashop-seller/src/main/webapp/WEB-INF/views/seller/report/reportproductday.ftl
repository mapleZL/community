...
<#assign currentBaseUrl="${domainUrlUtil.EJS_URL_RESOURCES}/seller/report/productday"/>
                ...
                <div class="fluidbox">
                    ...
                    <p class="p6 p-item">
                        ...
                        <input type="text" id="q_startTime" name="q_startTime"
                               onfocus="WdatePicker({dateFmt:'yyyy-MM-dd 00:00:00'})" class="txt w170"/>
                        -
                        <input type="text" id="q_endTime" name="q_endTime"
                               onfocus="WdatePicker({dateFmt:'yyyy-MM-dd 23:59:59'})" class="txt w170"/>
                    </p>
                </div>
            </form>
        </div>
