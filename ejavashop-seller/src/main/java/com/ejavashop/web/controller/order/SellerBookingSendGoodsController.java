...
import com.ejavashop.service.impl.order.OrdersProductServiceImpl;
 ...
 */
@Controller
@RequestMapping(value = "seller/product/sendgoods")
public class SellerBookingSendGoodsController extends BaseController{
	  ...
	  IOrdersProductService ordersProductService;
	   ...
	   /**
	    ...
	    public String index(HttpServletRequest request, Map<String, Object> dataMap) throws Exception {
	        ...
	        return "seller/product/sendgoods/booklist";
	    }
    ...
    public String add(Map<String, Object> dataMap,Integer id) {
        ...
        return  "seller/product/sendgoods/goodsedit";
    }
