...
$(function(){
	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/seller/pcindex/recommend/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加推荐类型<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/seller/pcindex/recommend">返回</a></span></h2>
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-numberbox w280" type="text" id="orderNo" name="orderNo" value="${(pcSellerRecommend.orderNo)!''}" data-options="required:true,max:99" >
						</p>
						<p class="p12 p-item">
