	...
	$(function() {
		...
		$('#btn_edit').click(function() {
			...
			$("#devWin").window({
				width :320,
				height : 200,
				href : '${currentBaseUrl}/edit?id='+selected.id+"&source=1",
				title : "修改订单金额",
				closed : true,
				shadow : false,
				modal : true,
		...
		$("#btn-setLabel").click(function(){
			...
			location.href='${currentBaseUrl}/setLabel?orderId='+selected.id;
		});
	});
...
<div data-options="region:'center'" border="false">
	...
	<div id="gridTools">
		...
		<@shiro.hasPermission name="/seller/order/orders/setLabel">
		<a id="btn-setLabel" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true">设置标签</a>
		</@shiro.hasPermission>
		
		<@shiro.hasPermission name="/seller/order/orders/setPrice">
