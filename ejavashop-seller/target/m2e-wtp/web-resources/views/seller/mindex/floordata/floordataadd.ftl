...
$(function(){
	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/seller/mindex/floordata/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加楼层数据<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/seller/mindex/floordata">返回</a></span></h2>
				...
				<dd class="dd-group">
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<select name="indexFloorId" id="indexFloorId" value="${(mSellerIndexFloorData.indexFloorId)!''}" data-options="required:true">
