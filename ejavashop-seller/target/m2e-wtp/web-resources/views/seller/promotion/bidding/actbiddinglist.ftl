...
<#assign currentBaseUrl="${(domainUrlUtil.EJS_URL_RESOURCES)!}/seller/promotion/actbidding"/>
...
<div id="searchbar" data-options="region:'north'" style="margin:0 auto;" border="false">
	<h2 class="h2-title">集合竞价列表 <span class="s-poar"><a class="a-extend" href="#">收起</a></span></h2>
