...
$(function(){
	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
            ...
            $('#descinfo').val(descinfo);//商品描述信息
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/seller/promotion/actbidding/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
	...
	$("#addActivityBiddingPrice").click(function(){
		var addActivityBiddingPrice = "";
	 	...
	 	addActivityBiddingPrice += "销量：<input type='text' data-saleNumberAll='saleNumberAll' class='txt w200 easyui-numberbox' data-options='min:1,max:99999,required:true' name='saleNumberAll'/>";
	 	addActivityBiddingPrice += "价格：<input type='text' data-priceNmberAll='priceNmberAll' class='txt w200 easyui-numberbox' data-options='min:1,max:99999,required:true' name='priceNmberAll'/>";
	 	...
	 	//$("input[type=text]").numberbox();
	 	//$("input[data-saleNumberAll=saleNumberAll]").numberbox();
	 	//$("input[data-priceNmberAll=priceNmberAll]").numberbox();
    });
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加集合竞价<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/seller/promotion/actbidding">返回</a></span></h2>
