	...
	$("#edit").click(function(){
		...
		if($("#addForm").form('validate')){
	    	...
	    	if (type == 1) {
	 		...
	 		$("#addForm").attr("action", "${domainUrlUtil.EJS_URL_RESOURCES}/seller/promotion/single/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑单品立减<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/seller/promotion/single">返回</a></span></h2>
