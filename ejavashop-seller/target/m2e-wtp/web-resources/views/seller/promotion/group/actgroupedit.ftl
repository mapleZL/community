...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">修改团购<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/seller/promotion/actgroup">返回</a></span></h2>
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<@cont.select id="channel" name="channel" codeDiv="CHANNEL" value="${(actGroup.channel)!}" mode="2"/>
						</p>
					</div>
					<br/>
					<div class="fluidbox">
