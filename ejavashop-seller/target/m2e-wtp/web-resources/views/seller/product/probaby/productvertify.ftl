        ...
        <div class="w-p99 marauto searchCont">
            <form class="form-search" action="doForm" method="post" id="queryForm" name="queryForm">
                <div class="fluidbox">
                    ...
                    <p class="p4 p-item">
                        <label class="lab-item">预约入库时间 :</label>
...
<div data-options="region:'center'" border="false">
    <table id="dataGrid" class="easyui-datagrid"
        ...
        <tr>
            ...
            <th field="sellerId" width="100" align="left">商家ID</th>
            <th field="SPU" width="100" align="center">品牌</th>
            <th field="totalAmount" width="100" align="center">预约入库总量量</th>
            <th field="dateProbaby" width="100" align="center">预约入库时间</th>
            <th field="createtime" width="100" align="center">创建时间</th>
            <th field="systemId" width="100" align="center">创建用户ID</th>
