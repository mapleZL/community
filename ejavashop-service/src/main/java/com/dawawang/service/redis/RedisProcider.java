//package com.dawawang.service.redis;
//
...
//            jedis = new Jedis("127.17.6.148", 6379);
//            //权限认证
//            jedis.auth("12345");
...
//            //添加数据
//            jedis.set("name", "ls"); //key为name放入value值为chx
...
//
//            //s设置多个键值对
//            jedis.mset("name", "luhsuai", "age", "25", "email", "lu1632278229@sina.cn");
