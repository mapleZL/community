 ...
 *   <tr><td>orderType</td><td>{@link java.lang.Integer}</td><td>order_type</td><td>Integer</td><td>订单类型：1、普通订单，2、限时抢购订单</td></tr>
...
public class Orders implements Serializable {
    ...
    /** 订单表  order_state  订单状态：10、删除*/
    public final static int      ORDER_STATE_10        = 10;

    /** 订单表  order_type  订单类型：1、普通订单，2、限时抢购订单，8、团购订单，9、竞价定金订单，10、竞价尾款订单 */
    public final static int      ORDER_TYPE_1         = 1;
    /** 订单表  order_type  订单类型：1、普通订单，2、限时抢购订单，8、团购订单，9、竞价定金订单，10、竞价尾款订单 */
    public final static int      ORDER_TYPE_2         = 2;
    /** 订单表  order_type  订单类型：1、普通订单，2、限时抢购订单，5、二次加工，8、团购订单，9、竞价定金订单，10、竞价尾款订单 */
    ...
    /** 订单表  order_type  订单类型：1、普通订单，2、限时抢购订单，8、团购订单，9、竞价定金订单，10、竞价尾款订单 */
    public final static int      ORDER_TYPE_10        = 10;
    ...
    /** 付款code：OFFSEND，线下打款 */
    public final static String   PAYMENT_CODE_OFFSEND = "OFFSEND";
    /** 付款code：BALANCE，余额支付 */
    ...
    /** 订单表  payment_status  付款状态：2、 买家未付款(二次包装已确认)*/
    public final static int      PAYMENT_STATUS_2     = 2;
    /** 订单表  payment_status  付款状态：3、改价订单，需要财务再次进行确认*/
    public final static int      PAYMENT_STATUS_3     = 3;
    /** 订单的优惠金额 针对翼支付便宜千分之3*/
    public final static BigDecimal  BESTPAY_DISCOUNT = new BigDecimal(0.997);
    /** 翼支付折扣开始时间*/
//    public final static String DISCOUNT_BEGIN_TIME = "20161219";
//    /** 翼支付折扣结束时间*/
//    public static String DISCOUNT_END_TIME = "20170630";
    //品牌袜提点
    public final static BigDecimal BRAND_PERCENT = new BigDecimal(0.01);
    //裸袜提点
    public final static BigDecimal LUOWA_PERCENT = new BigDecimal(0.005);
    ...
    private java.util.Date       outTime;//出库时间
	private java.lang.Integer    sendType = 0  ;//0:直发，1：代发	
    ...
    private Integer            sendArea;//送货上门区域
