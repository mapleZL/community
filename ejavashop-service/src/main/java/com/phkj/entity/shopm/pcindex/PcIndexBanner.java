package com.phkj.entity.shopm.pcindex;

import java.io.Serializable;

/**
 * PC端首页轮播图
 * <p>Table: <strong>pc_index_banner</strong>
 ...
 *
 */
public class PcIndexBanner implements Serializable {

    /**
     *Comment for <code>serialVersionUID</code>
     */
    private static final long serialVersionUID = -6597842539289159536L;
    ...
    /**
     * 这里不能默认为0 所有的更新都是new PcIndexBanner setId(id)这样会把原来的不是banner的 更新之后变成banner了
     */
    //默认给类型为0 表示为banner,为1时表示为弹出层,
