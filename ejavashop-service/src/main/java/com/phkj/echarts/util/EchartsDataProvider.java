...
import com.phkj.dto.PhurchaseRateDto;
import com.phkj.dto.ProductSaleDto;
import com.phkj.echarts.component.Legend;
import com.phkj.echarts.component.Option;
import com.phkj.echarts.component.Series;
import com.phkj.echarts.component.Series.MarkLine.MarkLineData;
import com.phkj.echarts.component.Series.MarkPoint.MarkPointData;
import com.phkj.echarts.component.SeriesData;
import com.phkj.echarts.component.Title;
import com.phkj.echarts.component.Toolbox;
import com.phkj.echarts.component.Tooltip;
import com.phkj.echarts.component.XAxis;
import com.phkj.echarts.component.YAxis;

/**
 * 用以echarts图表数据填充
 *                       
 * @Filename: DataFormatUtil.java
 * @Version: 1.0
 * @Author: zhaihl
...
public class EchartsDataProvider {
    ...
    public static String getOrderOverviewData(List<Object> data, String startTime, String endTime) {
        ...
        title.setSubtext(startTime + "-" + endTime);
        title.setX("center");
        opt.setTitle(title);
