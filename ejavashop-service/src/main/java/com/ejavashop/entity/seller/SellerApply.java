 ...
 *   <tr><td>madePerDay</td><td>{@link java.lang.Integer}</td><td>made_per_day</td><td>int</td><td>日产量</td></tr>
 *   <tr><td>employeeSum</td><td>{@link java.lang.Integer}</td><td>employee_sum</td><td>int</td><td>员工人数</td></tr>
 *   <tr><td>wellArea</td><td>{@link String}</td><td>well_area</td><td>varchar</td><td>擅长领域</td></tr>
 *   <tr><td>ownCate</td><td>{@link String}</td><td>own_cate</td><td>varchar</td><td>现有品类</td></tr>
 *   <tr><td>engineSum</td><td>{@link String}</td><td>engine_sum</td><td>varchar</td><td>拥有机型及台数</td></tr>
 * </table>
 *
 */
public class SellerApply implements Serializable {
    ...
    private Integer 			madePerDay;
    private Integer				 employeeSum;
    private String            wellArea;
    private String            ownCate;
    private String            engineSum;
	...
	public Integer getMadePerDay() {
		return madePerDay;
	}

	public void setMadePerDay(Integer madePerDay) {
		this.madePerDay = madePerDay;
	}
	...
	public String getOwnCate() {
		return ownCate;
	}

	public void setOwnCate(String ownCate) {
		this.ownCate = ownCate;
	}

	public String getEngineSum() {
		return engineSum;
	}

	public void setEngineSum(String engineSum) {
