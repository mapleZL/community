package com.ejavashop.entity.promotion.bidding;

import java.io.Serializable;

/**
 * 集合竞价首页轮播图
 * <p>Table: <strong>act_group_banner</strong>
 ...
 *   <tr><td>orderNo</td><td>{@link java.lang.Integer}</td><td>order_no</td><td>int</td><td>排序</td></tr>
 ...
 *   <tr><td>state</td><td>{@link java.lang.Integer}</td><td>state</td><td>tinyint</td><td>状态0不启用1启用</td></tr>
 *   <tr><td>pcMobile</td><td>{@link java.lang.Integer}</td><td>pc_mobile</td><td>tinyint</td><td>1、PC端图片；2、mobile端图片</td></tr>
 ...
 *
 */
public class ActBiddingBanner implements Serializable {

    /**
     *Comment for <code>serialVersionUID</code>
     */
    private static final long serialVersionUID = -6318609066884258345L;
    ...
    private java.lang.Integer pcMobile;
    ...
    /**
     * 获取1、PC端图片；2、mobile端图片
     */
    public java.lang.Integer getPcMobile() {
        return this.pcMobile;
    }

    /**
     * 设置1、PC端图片；2、mobile端图片
     */
    public void setPcMobile(java.lang.Integer pcMobile) {
