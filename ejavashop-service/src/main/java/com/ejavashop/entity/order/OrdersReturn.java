...
/**
 * 
 * <p>Table: <strong>orders_return</strong>
 ...
 *   <tr><td>orderType</td><td>{@link java.lang.Integer}</td><td>order_type</td><td>tinyint</td><td>订单类型：1、普通订单，2、限时抢购订单3.自提订单4.三方仓储订单</td></tr>
 ...
 *   <tr><td>orderState</td><td>{@link java.lang.Integer}</td><td>order_state</td><td>tinyint</td><td>订单状态：1、未付款的订单；2、待确认的订单；3、待发货的订单；4、已发货的订单；5、已完成的订单；6、取消的订单；7、申请退货 8、可退货 9、退货驳回</td></tr>
 *   <tr><td>payTime</td><td>{@link java.util.Date}</td><td>pay_time</td><td>datetime</td><td>付款时间</td></tr>
 *   <tr><td>paymentStatus</td><td>{@link java.lang.Integer}</td><td>payment_status</td><td>tinyint</td><td>付款状态：0 买家未付款 1 买家已付款 2 买家未付款(二次包装已确认)</td></tr>
 ...
 *   <tr><td>activityId</td><td>{@link java.lang.Integer}</td><td>activity_id</td><td>int</td><td>活动ID，为0正常购买</td></tr>
 ...
 *   <tr><td>createId</td><td>{@link java.lang.Integer}</td><td>create_id</td><td>int</td><td>退货创建人</td></tr>
 *   <tr><td>createTime</td><td>{@link java.util.Date}</td><td>create_time</td><td>datetime</td><td>退货创建时间</td></tr>
 ...
 *   <tr><td>tradeNo</td><td>{@link java.lang.String}</td><td>trade_no</td><td>varchar</td><td>交易编号一</td></tr>
 *   <tr><td>tradeSn</td><td>{@link java.lang.String}</td><td>trade_sn</td><td>varchar</td><td>交易编号二</td></tr>
 *   <tr><td>returnTime</td><td>{@link java.util.Date}</td><td>return_time</td><td>datetime</td><td>入库时间</td></tr>
 *   <tr><td>returnId</td><td>{@link java.lang.Integer}</td><td>return_id</td><td>int</td><td>入库操作人</td></tr>
 *   <tr><td>returnInfo</td><td>{@link java.lang.String}</td><td>return_info</td><td>varchar</td><td>退货说明</td></tr>
 *   <tr><td>returnState</td><td>{@link java.lang.Integer}</td><td>return_state</td><td>int</td><td>returnState</td></tr>
 * </table>
 *
 */
public class OrdersReturn implements Serializable {
	...
	/**
     * 获取订单类型：1、普通订单，2、限时抢购订单3.自提订单4.三方仓储订单
     */
	...
	/**
     * 设置订单类型：1、普通订单，2、限时抢购订单3.自提订单4.三方仓储订单
     */
	...
	/**
     * 获取付款状态：0 买家未付款 1 买家已付款 2 买家未付款(二次包装已确认)
     */
	...
	/**
     * 设置付款状态：0 买家未付款 1 买家已付款 2 买家未付款(二次包装已确认)
     */
