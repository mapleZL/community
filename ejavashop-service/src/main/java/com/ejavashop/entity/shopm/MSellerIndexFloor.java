 ...
 *
 */
public class MSellerIndexFloor implements Serializable {
    ...
    private List<MSellerIndexFloorData> datas;                                  // 当前楼层下得数据
    ...
    public List<MSellerIndexFloorData> getDatas() {
        return datas;
    }

    public void setDatas(List<MSellerIndexFloorData> datas) {
        this.datas = datas;
    }
