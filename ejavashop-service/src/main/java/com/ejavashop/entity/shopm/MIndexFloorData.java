 ...
 *
 */
public class MIndexFloorData implements Serializable {
    ...
    private MIndexFloor       mIndexFloor;                            // 楼层
    private Product           product;                                // 商品

    // --------额外属性（entity对应表结构之外的属性） end--------------------------------

    public String getMIndexFloorName() {
        if (mIndexFloor != null) {
            return mIndexFloor.getName();
        }
        return "";
    }
    ...
    public MIndexFloor getmIndexFloor() {
        return mIndexFloor;
    }

    public void setmIndexFloor(MIndexFloor mIndexFloor) {
        this.mIndexFloor = mIndexFloor;
    }
