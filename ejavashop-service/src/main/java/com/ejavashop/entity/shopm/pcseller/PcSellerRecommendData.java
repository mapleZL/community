package com.ejavashop.entity.shopm.pcseller;
...
/**
 * PC端商家推荐数据表
 * <p>Table: <strong>pc_seller_recommend_data</strong>
 * <p><table class="er-mapping" cellspacing=0 cellpadding=0 style="border:solid 1 #666;padding:3px;">
 *   <tr style="background-color:#ddd;Text-align:Left;">
 *     <th nowrap>属性名</th><th nowrap>属性类型</th><th nowrap>字段名</th><th nowrap>字段类型</th><th nowrap>说明</th>
 *   </tr>
 *   <tr><td>id</td><td>{@link java.lang.Integer}</td><td>id</td><td>int</td><td>id</td></tr>
 *   <tr><td>recommendId</td><td>{@link java.lang.Integer}</td><td>recommend_id</td><td>int</td><td>推荐类型ID</td></tr>
 ...
 *
 */
public class PcSellerRecommendData implements Serializable {

    /**
     *Comment for <code>serialVersionUID</code>
     */
    private static final long serialVersionUID = 4774310701787198796L;
    ...
    private PcSellerRecommend pcSellerRecommend;
    ...
    public String getRecommendTitle() {
        if (this.pcSellerRecommend != null) {
            return this.pcSellerRecommend.getTitle();
        }
        return "";
    }
    ...
    public PcSellerRecommend getPcSellerRecommend() {
        return pcSellerRecommend;
    }

    public void setPcSellerRecommend(PcSellerRecommend pcSellerRecommend) {
        this.pcSellerRecommend = pcSellerRecommend;
    }
