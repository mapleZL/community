...
public class CartInfoVO implements Serializable {
    ...
    */
    public BigDecimal getFinalAmount() {
        BigDecimal checkedDiscountedCartAmountP = this.checkedDiscountedCartAmount == null ? BigDecimal.ZERO
            : this.checkedDiscountedCartAmount;
