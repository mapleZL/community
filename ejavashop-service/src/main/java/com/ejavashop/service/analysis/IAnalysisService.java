package com.ejavashop.service.analysis;
...
public interface IAnalysisService {
    ...
    */
     ...
     * @return
     */
    ServiceResult<List<ProductLookLog>> getProductLookLogs(Map<String, String> queryMap, PagerInfo pager);
    

    ServiceResult<Integer> countProductLookLog(Map<String, String> queryMap);
    ...
    ServiceResult<Boolean> updateProductLookLog(ProductLookLog productLookLog);
}
